...
@Component({
  selector: 'app-pessoa-registering-process',
  templateUrl: './pessoa-registering-process.component.html',
  styleUrls: ['./pessoa-registering-process.component.scss'],
})
export class PessoaRegisteringProcessComponent implements OnInit {
