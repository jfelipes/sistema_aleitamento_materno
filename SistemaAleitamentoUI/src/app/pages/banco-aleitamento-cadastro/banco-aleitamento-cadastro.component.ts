...
@Component({
  selector: 'app-banco-aleitamento-cadastro',
  templateUrl: './banco-aleitamento-cadastro.component.html',
  styleUrls: ['./banco-aleitamento-cadastro.component.scss']
})
export class BancoAleitamentoCadastroComponent implements OnInit {
